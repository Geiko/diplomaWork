...
namespace BookArt.Areas.Admin.Controllers
{
    ...
    public class ManageFeedbacksController : Controller
    {
        ...
        // GET: Admin/ManageFeedbacks/Details/5
        ...
        // GET: Admin/ManageFeedbacks/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Admin/ManageFeedbacks/Create
        ...
        // GET: Admin/ManageFeedbacks/Edit/5
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UsersEmail,Content,Date")] Feedback feedback)
        {
            if (ModelState.IsValid)
            {
        ...
        // GET: Admin/ManageFeedbacks/Delete/5
        ...
        // POST: Admin/ManageFeedbacks/Delete/5
