...
//$(document).ready(function () {
    ...
    //==========================================
    var svgHeight = 500;
    //var svgaHeight = $(document).height() * 0.6667;
    //console.log($(document).height() + '  ' + svgaHeight);

    var isFirstEnter = $('.enterSession').text();
    var durK = 0;
    var durT = 0;
    if (isFirstEnter == 1) {
        durK = 6000;
    ...
    setTimeout(proceedT, picture.durationK + durBetween);
